                                                ...
                                                <td colspan="5">
                                                    <div class="text-center mt-2">
                                                        <figure class="mx-auto mb-4">
                                                            <img src="{{ config('theme.cdn_url') }}images/undraw/undraw_schedule_pnbk.svg" alt="SVG" width="20%">
                                                        </figure>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5">
                                                    <div class="text-center mt-2">
                                                        <figure class="mx-auto mb-4">
                                                            <img src="{{ config('theme.cdn_url') }}images/undraw/undraw_events_2p66.svg" alt="SVG" width="20%">
                                                        </figure>
