<template>
    <div class="row">
        <div class="col-12">
            <div v-if="!newLocation && !change_address">
                <div class="page-title-right">
                    <button type="button" class="btn btn-outline-primary" @click="change_address = true">Trocar
                        Endereço
                    </button>
                </div>
            ...
            <div v-else>
                <div class="row">
                    <div class="col-6">
                        <button type="button" class="btn btn-warning" @click="change_address = false"
                                v-if="!newLocation">Cancelar
                        </button>
                    </div>
                </div>
                ...
                <div>
                    <div class="form-group">
                        <label class="col-form-label"> Endereço ou Nome do Local do Evento <span
                    ...
                    <div class="row" v-if="place">
                        <div class="form-group col-md-8">
                            ...
                            <input class="form-control" type="text" name="place_name" placeholder="Nome do Bairro"
                                   :class="errors.has('place_name') ? 'is-invalid' : ''" v-model="place_name"
                                   data-vv-as="'Nome do Local'" v-validate="'required'">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="street" placeholder="Nome da rua"
                                   :class="errors.has('street') ? 'is-invalid' : ''" v-model="street"
                                   data-vv-as="'Logradouro'" v-validate="'required'">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <input class="form-control" type="text" name="district" placeholder="Nome do Bairro"
                                   :class="errors.has('district') ? 'is-invalid' : ''" v-model="district"
                                   data-vv-as="'Bairro'" v-validate="'required'">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="text" name="complement" placeholder="Ex: Casa, Loja 01..."
                                   v-model="complement">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="number" name="number" placeholder="Ex: 55"
                                   :class="errors.has('number') ? 'is-invalid' : ''" v-model="number"
                                   data-vv-as="'Número'" v-validate="'required'">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control disabled" readonly disabled name="state"
                                   :value="state">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control disabled" readonly disabled name="city"
                                   :value="city">
                        </div>
        ...
        <div class="col-12 mt-2">
            <gmap-map :center="center" :zoom="zoom" style="width:100%;  height: 300px;">
